...
| Regularly test security systems and processes. | ✅ Compliant | Packaged releases are periodically scanned. Security maintenance releases address newly identified vulnerabilities. See [Vulnerability Reports](../../Solution_Admin/Vulnerability-Report-4.10.md). |
...
- [Vulnerability Report 4.10](../../Solution_Admin/Vulnerability-Report-4.10.md)
