...
summary: "Overview of customer profile management in ExpertFlow CX — unified interaction profiles, custom attributes, labels, advanced filters, and CRM integration."
product-area: [customers]
doc-type: explanation
difficulty: beginner
keywords: ["customer management", "customer profile", "customer interaction profile", "360 view", "customer attributes", "CRM integration", "customer labels", "customer filters"]
...
See [Customer Labels](Customer-Labels.md) for full details.

### Advanced Filters

Build and save customized customer list views using AND/OR filter conditions for contact segmentation and outbound campaigns.

See [Customer Advanced Filters](Customer-Advanced-Filters.md) for full details.
