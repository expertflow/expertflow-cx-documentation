---
title: "closeWrapup"
summary: "Emitted by Agent Desk to Agent Manager requesting that WrapUp events be published for a conversation."
audience: [developer-integrator]
product-area: [sdk, platform]
doc-type: reference
difficulty: advanced
keywords: ["closeWrapup socket event CX", "closeWrapup Agent Manager CX", "Socket.IO CX"]
aliases: ["closeWrapup event ExpertFlow", "closeWrapup socket CX"]
last-updated: 2026-03-12
---

# closeWrapup

Event is emitted when an agent requests the Agent Manager to publish WrapUp events for a conversation.

| Property | Value |
|---|---|
| **Event Name** | `closeWrapup` |
| **Emitter** | Agent Desk |
...
- [CIM Messages](../CIM_Message_Schema/CIM-Messages.md)
