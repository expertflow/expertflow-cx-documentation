...
> See [Onboarding a New Tenant](../../Getting_Started/For_Hosting_Partners/Onboarding-a-New-Tenant.md) for the full API payload and script instructions.
...
> The [Getting Started: Onboarding a New Tenant](../../Getting_Started/For_Hosting_Partners/Onboarding-a-New-Tenant.md) guide covers each of these areas in sequence.
