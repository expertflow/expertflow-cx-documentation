# CX Knowledgebase : pullModeSubscribedListRequests

Event Name| pullModeSubscribedListRequests  
---|---  
Event Description| Event is triggered if there are chat requests present in a list subscribed by the agent.  
