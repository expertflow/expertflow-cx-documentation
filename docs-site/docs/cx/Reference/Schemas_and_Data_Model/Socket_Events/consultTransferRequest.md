---
title: "consultTransferRequest"
summary: "Emitted by Agent Desk when an agent wants to leave the conversation and transfer it to another agent from a queue."
audience: [developer-integrator]
product-area: [sdk, platform]
doc-type: reference
difficulty: advanced
keywords: ["consultTransferRequest socket event CX", "consultTransferRequest Agent Manager CX", "Socket.IO CX"]
aliases: ["consultTransferRequest event ExpertFlow", "consultTransferRequest socket CX"]
last-updated: 2026-03-12
---

# consultTransferRequest

Event is emitted when an agent wants to leave the conversation and transfer it to another agent from a certain queue. The Agent Desk emits `consultTransferRequest` and the Routing Engine finds another available agent until the TTL time expires.
