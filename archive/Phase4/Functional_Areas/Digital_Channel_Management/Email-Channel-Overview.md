...
audience: [solution-admin, supervisor, agent, decision-maker]
...
| **Microsoft Exchange (EWS)** | [Email Configuration — MS Exchange](../../Solution_Admin/Media-Server-Configuration-CX-Voice.md) |

## Related Articles

- [Routing Strategy: Pull Mode](../../Solution_Admin/Routing-Strategy-Pull-Mode.md)
...
- [Configuring Wrap-up Forms](../../Solution_Admin/Configuring-Wrap-up-Forms.md)
