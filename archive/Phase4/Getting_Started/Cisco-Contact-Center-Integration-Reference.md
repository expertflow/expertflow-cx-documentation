...
*For detailed version compatibility and component-level configuration, see the [Cisco Voice Channel Configuration Guide](../Integrator/Cisco-Voice-Channel-Configuration.md).*
