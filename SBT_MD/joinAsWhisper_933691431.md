# CX Knowledgebase : joinAsWhisper
...
---|---  
**Event Description**|  Event is emitted when supervisor requests to agent manager to whisper an active conversation instead of being a silent member.  
**Emitter**|  Agent Desk  
