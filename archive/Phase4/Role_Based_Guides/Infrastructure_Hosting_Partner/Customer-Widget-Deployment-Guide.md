...
audience: [partner, solution-admin]
...
- [Configuring the Customer Widget](../Solution_Admin/Configuring-the-Customer-Widget.md)
- [Customer Widget Features and Capabilities](../Solution_Admin/Customer-Widget-Features-Capabilities.md)
- [JavaScript SDK for Customer-Facing Channels](../Developer/JavaScript-SDK.md)
- [Customer-Facing SDK for Omnichannel Communication](../Developer/Customer-Facing-SDK.md)
