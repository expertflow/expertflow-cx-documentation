# CX Knowledgebase : closeWrapup

**Event Name**|  closeWrapup  
---|---  
**Event Description**|  Event is emitted when agent requests to agent manager for publishing WrapUp events  
**Emitter**|  Agent Desk  
  
**Name**| **Description**| **Payload Properties**  
---|---|---  
cimEvent| type: Objectcontains parameter required for sending messages | 
