...
Provide the desired FQDN in the `tenantId.root-domain` format when registering the tenant via the CX Tenant API. See [Onboarding a New Tenant](../../Getting_Started/Onboarding-a-New-Tenant.md) for the registration payload.
...
- [Onboarding a New Tenant](../../Getting_Started/Onboarding-a-New-Tenant.md)
