...
> **Solution Admins** can only see their own tenant's license data. See [Monitoring Tenant License Consumption](../Solution_Admin/Monitoring-Tenant-License-Consumption.md) for that view.
...
- [Monitoring Tenant License Consumption](../Solution_Admin/Monitoring-Tenant-License-Consumption.md) *(Admin view)*
