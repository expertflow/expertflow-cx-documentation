...
SMPP requires connection parameters from your SMS gateway provider (IP, port, system ID, password, bind type). For full configuration steps, see [SMPP Configuration Guide](SMPP-Configuration-Guide.md).

## Related Articles

- [SMPP Configuration Guide](SMPP-Configuration-Guide.md)
