...
With the connector registered, implement the message exchange between your connector and CCM following the [Channel Connector Developer Guide](Channel-Connector-Developer-Guide.md) and the [CIM Messages](../Developer/CIM-Message-Schema/CIM-Messages.md) schema reference.
