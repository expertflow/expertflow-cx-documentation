...
### Routing Logic
Incoming WhatsApp messages can be routed based on keywords, sentiment, or customer priority using the [Universal Routing Engine](../../../Role_Based_Guides/Developer/Agent-Task-Routing-Lifecycle.md).
