...
- **[Outbound Summary Report](../Reporting_and_Analytics/Outbound-Summary-Report.md)**: Agent-level summary of outbound outcomes by date and channel.
- **[Campaign Performance Reports](../../How-to_Guides/Supervisor_and_QA_Lead/Campaign-Performance-Reports.md)**: Campaign-level connect rates, attempts, and contact list progress.
