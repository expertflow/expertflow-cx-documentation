# CX Knowledgebase : Create Form

This API allows you to create form. The endpoints, properties and code examples are given as follows:
...
**Code**| **Description**  
---|---  
**200**|  Code 200 implies that the message has been accepted.   
