...
_What pain does this solve? e.g. low survey response rates via email, no scalable way to collect feedback from voice customers, manual outreach after calls._

## What You Can Build

_One paragraph establishing that Survey Campaigns are outbound, business-initiated feedback flows — distinct from post-call surveys triggered automatically._

### SMS Survey Campaign

_Brief outcome statement — example: post-call NPS via SMS, triggered automatically when a call ends on a specific service._
...
_1. Build the survey form (NPS, CSAT, MCQ questions)._
_2. Design the outbound flow in the Campaign Flow Builder._
_3. Set the trigger (call end event, schedule, or manual launch) — the platform handles delivery, branching, opt-outs, and reporting._
