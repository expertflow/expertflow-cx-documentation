...
> These figures cover the Media Server component. CX Core Platform hardware is sized separately. See [Sizing Guidelines](../../How-to_Guides/Administrator/Sizing-Guidelines.md).
