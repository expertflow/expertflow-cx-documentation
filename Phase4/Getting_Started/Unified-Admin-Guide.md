...
- *For detailed channel setup, see the [Digital Channel Management](../Archive-Notice.md) section.*
...
*Looking for specialized guides? Check out [Managing Campaigns](../Solution_Admin/Managing-Outbound-Campaigns.md) or [Managing the QA Workflow](Managing-the-Quality-Assurance-Workflow.md).*
