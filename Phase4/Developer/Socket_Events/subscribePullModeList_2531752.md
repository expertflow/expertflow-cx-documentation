# CX Knowledgebase : subscribePullModeList

**Event Name**|  subscribePullModeList  
---|---  
**Event Description**|  When an agent subscribes to a list the agent desk emits an event of subscribePullModeList to the agent manager, agent manager listens to the event and successfully subscribes to the list for that agent.  
**Emitter**|  Agent Desk  
...
listId| type: StringID of the list subscribed by the agent | -  
list| type: Objectproperties of the subscribed list| 
