...
**Wrap-up** values that are blank or appear inconsistent can indicate agents closing calls without completing the wrap-up form, or a configuration issue in wrap-up form assignment. See [Configuring Wrap-up Forms](../../Solution_Admin/Configuring-Wrap-up-Forms.md).

## Related Articles

- [Outbound Summary Report](../Performance_Insights_Data/Outbound-Summary-Report.md)
- [Outbound Calls](Outbound-Calls.md)
- [CX Dialer Reference](CX-Dialer-Reference.md)
- [Campaign Performance Reports](../../Supervisor/Campaign-Performance-Reports.md)
