...
| [`topicUnsubscription_`](./topicUnsubscription_.md) | Emitted when an agent unsubscribes from a conversation topic. |
...
| [`agentPresence_`](./agentPresence_.md) | Triggered to update agent state information (MRD states, availability). |
...
| [`connect_error`](./connect_error.md) | Triggered when an error occurs during the Socket.IO handshake (e.g., unauthorized user, invalid data). |
