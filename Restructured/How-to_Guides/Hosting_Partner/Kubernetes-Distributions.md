...
To set up RKE2 for an ExpertFlow CX deployment, see [RKE2 Control Plane Deployment](../../Getting_Started/For_Hosting_Partners/Deploying-the-RKE2-Control-Plane.md).
