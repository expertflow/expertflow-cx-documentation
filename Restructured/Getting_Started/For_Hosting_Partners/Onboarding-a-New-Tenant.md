...
Add the new subdomain to Grafana's allowed hosts list by updating the `allowedHosts` configuration in the Grafana deployment values.
...
*Next step: Hand off to the Solution Admin with the [Unified Admin Guide](../For_Administrators/Unified-Admin-Guide.md) to complete channel and routing configuration.*
