...
*For exhaustive payload schemas, see the [Master Socket Events List](../../Reference/Schemas_and_Data_Model/Socket_Events/index.md) or the [CIM Message Objects Reference](../../Reference/Schemas_and_Data_Model/CIM_Message_Schema/CIM-Messages.md).*
