# CX Knowledgebase : Media Server Configurations for CX Voice (old)
...
EFCX| 4.10| [Installation](/wiki/pages/createpage.action?spaceKey=SBT&title=CX%20Deployment%20on%20Kubernetes&linkCreation=true&fromPageId=75825154)  
...
[code] mv cx_env.lua cx_env1555.lua
[/code]
...
### Configuration
  ...
  1. Open _**cx_env{DN}.lua**_ : 
[code] vi /usr/share/freeswitch/scripts/cx_env{DN}.lua
[/code]
[code] local config = {}
         config = {
             ...
             -- queueType = '',
             -- CxFQDN
             cxFqdn = "https://devops.com",
             -- API of voice connector for reserving an agent
             voiceConnectorApi = "http://VC-IP:VC-PORT",
...
[/code]
  ...
  5. If **queue** and **queueType** are set to **''** , then the call will be routed to the default queue set for the [CX Voice channel in Unified Admin](https://expertflow-docs.atlassian.net/wiki/x/w5km).
  ...
  9. Save and exit the file by pressing the _**Esc** _key, entering _**:wq**_ and pressing **ENTER**.

  10. Steps 11-15 below are optional, in case Post-Call-Survey is in use.

  11. Open _**pcs1_env.lua**_ : 
...
[/code]
  ...
  12. Press the **"I"** key to enter editing mode.

  13. The **formId** will contain the ID of the **PCS Survey form** created on Unified Admin (make sure that audio prompts were uploaded for each question).

  14. The **cxFqdn** field contains the fully qualified domain name of the EFCX:

     1. Replace **devops.expertflow.com** with the EFCX domain name.

  15. The **ivr_prompts_folder** field contains path to the **ivr_prompts** folder. Leave it at the default value.

  16. Save and exit the file by pressing the _**Esc** _key, entering _**:wq**_ and pressing **ENTER**.
...
![](attachments/75825154/87425031.png?width=623)
...
![](attachments/75825154/87130117.png?width=732)

  * Select the ADD button on the top right.


![](attachments/75825154/87130122.png?width=716)
...
![](attachments/75825154/75825190.png?width=676)
...
![](attachments/75825154/87293960.png?width=500)
...
![](attachments/75825154/87556113.png?width=610)

  * Open the Dialplan Manager section under the Dialplan tab. 


![](attachments/75825154/87752729.png?width=658)

  * Add a new Dialplan by pressing the Add Button on the top.


![](attachments/75825154/75825274.png?width=658)
...
![image-20250304-074926.png](attachments/75825154/941031532.png?width=700)
...
![](attachments/75825154/87719951.png?width=728)
...
![](attachments/75825154/87162882.png?width=500)
...
![](attachments/75825154/87719946.png?width=696)

  * Open the Dialplan Manager section under the Dialplan tab. 


![](attachments/75825154/87752729.png?width=674)
...
![image-20250304-081009.png](attachments/75825154/940736714.png?width=700)
  * Set the **Context** field to the value of the **Domain** set in the **Domain creation** section.
  ...
  * If H264 codec is not added please add this codec. Follow the next step. 
...
![](attachments/75825154/87097346.png?width=500)
...
![](attachments/75825154/87687184.png?width=658)

  * Open the Dialplan Manager section under the Dialplan tab. 


![](attachments/75825154/87752729.png?width=654)

  * Add a new Dialplan by pressing the Add Button on the top.


![](attachments/75825154/75825274.png?width=642)
...
![image-20250722-101756.png](attachments/75825154/1203535927.png?width=700)
...
![image-20241211-061748.png](attachments/75825154/742031486.png?width=750)
...
![image-20241211-061407.png](attachments/75825154/742490114.png?width=750)
...
![](attachments/75825154/87490569.png?width=500)
...
![](attachments/75825154/87523345.png?width=665)
...
![image-20250505-082711.png](attachments/75825154/1062010933.png?width=800)
...
![](images/icons/grey_arrow_down.png)Disable voicemail Dialplan
...
![image-20251104-103050.png](attachments/75825154/1412202539.png?width=1240)
...
![image-20251104-103332.png](attachments/75825154/1412595719.png?width=1320)
...
![image-20240822-053906.png](attachments/75825154/466911288.png?width=776)

  * Open the profile named **default** :


![image-20240822-054148.png](attachments/75825154/466911295.png?width=776)

  * Under the **Profile Parameters**, find the following keywords under the **Name** column and click the checkbox:


![image-20241129-135352.png](attachments/75825154/715849970.png?width=770)

  * Press **TOGGLE** in the top right and choose **CONTINUE** in the prompt shown.


![image-20241129-135211.png](attachments/75825154/715849964.png?width=770)
...
![](attachments/75825154/87752705.png?width=500)
...
![](attachments/75825154/87687184.png?width=726)

  * Open the **Gateways** section under the **Accounts** tab.


![image-20240424-103321.png](attachments/75825154/233767034.png?width=716)

  * Press the **ADD** button in the top right.


![image-20240424-103357.png](attachments/75825154/233799798.png?width=732)
...
![image-20240424-103500.png](attachments/75825154/233406653.png?width=692)

  * Open this newly created gateway and note the **URL** opened in the browser.


![image-20240424-103612.png](attachments/75825154/233734303.png?width=676)
...
![](attachments/75825154/234356812.png?width=728)

  * Open the **external** profile and note the value of the **apply-register-acl** field.


![image-20240424-103735.png](attachments/75825154/234520630.png?width=716)

  * Open **Access controls** under the **Advanced** tab.


![image-20240424-103757.png](attachments/75825154/233767040.png?width=640)

  * Open the entry that matches the aforementioned **apply-register-acl** field.


![image-20240424-103813.png](attachments/75825154/233865338.png?width=658)
...
![image-20240424-103838.png](attachments/75825154/234258516.png?width=666)
...
![image-20240424-103707.png](attachments/75825154/234356812.png?width=658)

  * Open the **external** profile and note the value of the **sip-port** field.


![image-20240424-103930.png](attachments/75825154/234750000.png?width=654)
...
![image-20240424-104001.png](attachments/75825154/234356820.png?width=665)
...
![](attachments/75825154/153878608.png?width=658)

  * Press the **ADD** button in the top right.


![](attachments/75825154/153420192.png?width=658)
...
![image-20241023-080613.png](attachments/75825154/614563863.png?width=750)
...
![](attachments/75825154/87687184.png?width=689)

  * Open the **Destinations** section under the **Dialplans** tab.


![](attachments/75825154/154075235.png?width=676)

  * Press the **ADD** button in the top right.


![](attachments/75825154/153715030.png?width=646)
...
![](attachments/75825154/153092678.png?width=707)

  * Press the **ADD** button in the top right.


![](attachments/75825154/153649503.png?width=665)
...
![](attachments/75825154/87687184.png?width=654)

  * Open **SIP Profiles** under the **Advanced** tab.


![image-20240424-103707.png](attachments/75825154/234356812.png?width=640)
...
![image-20240503-121016.png](attachments/75825154/246317617.png?width=630)
...
![image-20240503-121411.png](attachments/75825154/246415562.png?width=686)
...
![](attachments/75825154/87687184.png?width=686)

  * Open the **Access Control List** from the **Advanced** tab.


![](attachments/75825154/87031831.png?width=692)

  * Create a new **ACL** with the **Add** button.


![](attachments/75825154/87490585.png?width=716)
...
![](attachments/75825154/75825253.png?width=832)
...
![](attachments/75825154/75825250.png?width=750)
...
![](attachments/75825154/87293973.png?width=693)

  * Click the **Reload ACL** button on the top right.


![](attachments/75825154/75825241.png?width=658)
...
![](attachments/75825154/87326732.png?width=500)
