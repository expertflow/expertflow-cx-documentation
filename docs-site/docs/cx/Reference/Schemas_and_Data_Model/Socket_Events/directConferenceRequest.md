---
title: "directConferenceRequest"
summary: "Emitted by Agent Desk when an agent requests another agent from a queue to join the active conversation directly as a conference participant."
audience: [developer-integrator]
product-area: [sdk, platform]
doc-type: reference
difficulty: advanced
keywords: ["directConferenceRequest socket event CX", "directConferenceRequest Agent Manager CX", "Socket.IO CX"]
aliases: ["directConferenceRequest event ExpertFlow", "directConferenceRequest socket CX"]
last-updated: 2026-03-12
---

# directConferenceRequest

Event is emitted when an agent requests another agent from a certain queue to join the active conversation. The Agent Desk emits `directConferenceRequest` and the Routing Engine finds another available agent until the TTL time expires.
...
| `queueName` | String | The name of the queue from which another agent is required to be added as part of the conversation. |
