...
## Result
All EFCX reporting metadata and connections are now removed. You may now proceed with importing a new package via the [Superset Import Guide](../../_unmapped/Archive-Notice.md).
